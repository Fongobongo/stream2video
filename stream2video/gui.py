...
class Stream2VideoGUI(ctk.CTk):
    ...
    def _build_waveform_tab(self, parent):
        """Populate the Waveform tab with controls and image label."""
        ...
        self.lbl_wave_image.pack(fill="both", expand=True, padx=4, pady=(2, 4))
