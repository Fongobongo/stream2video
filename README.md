...
# Import a Twitch channel or YouTube channel/playlist: shows a numbered
# table of the entries (duration, views, title) and prompts for which
# ones to compress
silencecut https://www.twitch.tv/<channel>/videos
silencecut https://www.youtube.com/@<handle>/videos
silencecut "https://www.youtube.com/playlist?list=<id>"
